...
$pageTitle = 'Registration Matrix';
require __DIR__ . '/../templates/layout/header.php';
?>
<div class="d-flex justify-content-between align-items-center mb-3 no-print">
    <h4 class="mb-0"><i class="fa-solid fa-table-cells me-2"></i>Registration Matrix</h4>
    <div>
        <a href="export-registration-matrix.php?<?= http_build_query($_GET) ?>"
...
<div class="card shadow-sm border-0">
    <div class="card-body">
        <?php if (!$report['rows']): ?>
            <div class="alert alert-info mb-0">No members match those filters.</div>
        <?php else: ?>
            <div class="table-responsive matrix-wrap">
                <table class="table table-sm table-bordered align-middle matrix-table" id="tblRegMatrix">
            ...
            <div class="text-muted small mt-2">
                ...
                A dot (<code>·</code>) means nothing was due for that month.
                Card fee is included in the member total but shown separately from monthly columns.
            </div>
        <?php endif; ?>
    </div>
</div>
