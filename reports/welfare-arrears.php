...
$report = Report::balanceMatrix($f + ['type' => 'WELFARE']);

$pageTitle = 'Welfare Arrears';
require __DIR__ . '/../templates/layout/header.php';
?>
<div class="d-flex justify-content-between align-items-center mb-3 no-print">
    <h4 class="mb-0"><i class="fa-solid fa-hand-holding-heart me-2"></i>Registration Arrears</h4>
    <div>
        <a href="export-welfare-arrears.php?<?= http_build_query($_GET) ?>"
